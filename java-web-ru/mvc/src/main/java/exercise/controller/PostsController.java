...
public class PostsController {
    ...
    public static void edit(Context ctx) {
        try {
            ...
            var post = PostRepository.find(Long.parseLong(id)).orElseThrow(() -> new NotFoundResponse("Not found id"));
            var page = new EditPostPage(Long.parseLong(id), post.getName(), post.getBody(), null);
    ...
    public static void update(Context ctx) {
        try {
            ...
            var name = ctx.formParam("name");
            var body = ctx.formParam("body");
            var page = new EditPostPage(Long.parseLong(id), name, body, e.getErrors());
